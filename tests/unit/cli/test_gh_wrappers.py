...
The three commands shell out to ``gh``. Tests patch ``subprocess.run``
at the relevant module level and assert the right command was issued.
"""
...
def test_gh_pr_close_invokes_helper(monkeypatch) -> None:
    ...
    error-capture semantics apply as in session_abandon."""
    from tripwire.cli import gh as gh_mod
