...
The four-lens prompt content lives only in this module by design. It
does not appear in any spec, plan, issue, or other document that the
executing agent reads before the lifecycle event fires.
"""
